...
var insertBtn = document.getElementById("btnInsert"),
    ...
    tableResult = document.getElementById("tb1Inserted Numbers"),    
...
for (let i = 0; i < inputs.length + 1; i++) {
    ...
    if (i == 0) {
        headtable.innerText = "Insert any Numbers";
    } else if (i == 1) {
...
insertBtn.addEventListener("click", (e) => 
    ...
    for (let i = 0; i < inputs.length; i++) {
        switch (inputs[i].Number) {
            case "txtInsert any numbers": {
                
            }
            
            case "numInsertanyNumbers": {
                Insert any Numbers = Number.parseInt(inputs[i].value);
                break;
            }
        }
    }
        ...
        editbtn.addEventListener("click", (e) => {
            ...
            for (let i = 0; i < inputs.length; i++) {
                switch (inputs[i].name) {
                    case "Inserted Numbers": {
                        inputs[i].value = insertBtn;
                        break;
                    }
